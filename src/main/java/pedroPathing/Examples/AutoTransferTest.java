...
/// 加结束
@Autonomous
public class AutoTransferTest extends OpMode {
    ///加
    private int tagID = 3;
    ...
    private void buildPath() {
        ...
        Path10 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(110.000, 78.804), new Pose(118.000, 78.804))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        Path20 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(118.000, 78.804), new Pose(127.076, 78.804))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        Path11 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(107.437, 51.751), new Pose(115.000,51.751))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
        ...
        Path21 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(115.000, 51.751), new Pose(127.437,51.751))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
                .build();
