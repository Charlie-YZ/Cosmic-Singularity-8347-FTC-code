...
/// 加结束
@Autonomous
public class Blue_Front_nine extends OpMode {
    ///加
    ...
    private void buildPath() {
        ...
        Path2 = follower
                ...
                .setLinearHeadingInterpolation(Math.toRadians(90), Math.toRadians(180-38+2))
                .build();
        ...
        Path4 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-102.639-6, 78.056+4), new Pose(144-110.000-6, 78.804+4))
                )
        ...
        Path10 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-110.000-6, 78.804+4), new Pose(144-127.076, 78.804+4))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        Path5 = follower
                ...
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180-38+2))
                .build();
        ...
        Path6 = follower
                ...
                .addPath(
                        new BezierCurve(
                                ...
                                new Pose(144-103.937-3-2, 51.406+4)
                        )
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-38), Math.toRadians(180))
                .build();
        ...
        Path7 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-103.937-3, 51.406+4), new Pose(144-107.437-2, 51.751+4))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        Path20 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-107.437-2, 51.406+4), new Pose(144-107.437-2-3, 51.751+4))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
        ...
        Path11 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-107.437-2-5-3, 51.751+4), new Pose(144-127.437-2,51.751+4))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(180))
                .build();
