...
/// 加结束
@Autonomous
public class Blue_Back_three extends OpMode {
    ///加
    private int tagID = 3;
    ...
    private void buildPath() {
        ...
        Path1 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-91.322, 1.675), new Pose(144-91.322, 18.437))
                )
        ...
        Path2 = follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(144-91.322, 18.437), new Pose(144-130.096, 2.685))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180-67), Math.toRadians(180))
                .build();
    }
    ...
    public void init() {
        ...
        follower.setStartingPose(new Pose(144-91.322, 1.675,Math.toRadians(90)));
        buildPath();
